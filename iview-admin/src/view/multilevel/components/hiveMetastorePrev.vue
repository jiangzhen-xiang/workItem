<template>
  <div>
    ...
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="110">
      ...
      <FormItem label="cm.server" prop="hiveMetastoreServer">
        <Input v-model="formValidate.hiveMetastoreServer" placeholder="请输入" disabled></Input>
      </FormItem>
      <!-- <FormItem label="security.protocol" prop="securityProtocol">
        <Select
          v-model="formValidate.securityProtocol"
          placeholder="请选择"
          disabled
        >
          <Option
      ...
      <FormItem label="sasl.mechanism" prop="saslMechanism">
        <Select
          v-model="formValidate.saslMechanism"
          placeholder="请选择"
          disabled
        >
          <Option
...
export default {
  ...
  methods: {
    ...
    getFormData() {
      ...
      jsonInfoData["hive-metastoreServer.server"] =
        postData["hiveMetastoreServer"];
