  ...
  <div>
    ...
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="110">
      <FormItem label="账号" prop="user">
        <!-- <Select v-model="formValidate.user" placeholder="请选择">
          <Option
                ...
                <div class="ivu-list-item">
                  <div class="ivu-list-item-meta">
                    ...
                    <div class="ivu-list-item-meta-content">
                      <div class="ivu-list-item-meta-title">{{ item.name || item.fileName }}</div>
                    </div>
                  </div>
                  <ul class="ivu-list-item-action">
                    <li>
                      <a @click="setFilePrev(item, index)">预览</a>
                    </li>
                  </ul>
                </div>

                <div
                  style="padding-top: 10px;position: relative;z-index: 0;"
                  v-if="item.isShowPrev"
                >
                  <a
                    class="ivu-btn"
...
<script>
import { ajaxGetAccount, ajaxFilePrev, ajaxSetConnToEnvTestConn } from '@/api/link.js'
