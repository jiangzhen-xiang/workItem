  ...
  <div>
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="120">
      <FormItem label="cm.server" prop="hiveMetastoreServer">
        <Input v-model="formValidate.hiveMetastoreServer" placeholder="请输入"></Input>
      </FormItem>
...
export default {
  ...
  methods: {
    ...
    getFormData() {
      ...
      jsonInfoData["hive-metastoreServer.server"] = postData["hiveMetastoreServer"];
      // 设置连接的类型
