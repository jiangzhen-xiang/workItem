  ...
  <div>
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
      ...
      <FormItem label="集群" prop="clusterId">
        <Select v-model="formValidate.clusterId" placeholder="集群选择" @on-change="colonyChange">
          <Option
      ...
      <FormItem label="连接名称" prop="connName">
        <Input v-model="formValidate.connName" placeholder="请输入" disabled></Input>
      </FormItem>
