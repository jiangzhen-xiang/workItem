        ...
        <Card>
          ...
          <div class="wrapper">
            ...
            <textarea name="" id="" cols="30" rows="10">
              SELECT   SUM(o.amount * r.rate) AS amount FROM Topic-A AS o,
            Topic-B AS r WHERE r.currency = o.currency AND r.rowtime = (
            SELECT MAX(rowtime)   FROM Topic-B AS r2   WHERE r2.currency =
            o.currency   AND r2.rowtime <= o.rowtime);
            </textarea>
          </div>
        </Card>
      </i-col>
