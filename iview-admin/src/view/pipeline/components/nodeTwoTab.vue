        ...
        <div class="tabConten">
          <Form ref="formSource" :model="formSource" :rules="ruleValidate" :label-width="80">
            ...
            <FormItem label="数据集" prop="dataSetName">
              <Row>
                <Col span="22">
                  <Select v-model="formSource.dataSetName" placeholder="请输入" filterable>
                    <Option
      ...
      <TabPane label="源选项" name="name2">
        ...
        >
          ...
          <!-- <FormItem label="数据集" prop="dataSetName">
            <Row>
              <Col span="22">
                <Select v-model="formSourceOption.dataSetName" placeholder="请输入" filterable>
                  <Option
                    v-for="(item,index) in outputStreamArr"
                    :value="item.linkName"
                    :label="item.linkName"
        ...
        <div class="wrapper">
          ...
          >
            ...
            <template slot-scope="{ row }" slot="type">
              <Select v-model="row.type" placeholder="请输入" filterable >
                <Option
          ...
          <div style="border:solid 1px #ddd;border-radius:5px;padding:5px;">
            ...
            <div class="itemWrapper">
              ...
              >
                <Row>
                  <Col span="18">
                    <Select v-model="item.columnName" filterable>
