<template>
  <div>
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="120">
      ...
      <FormItem label="对应topic" prop="topicName">
        <Select v-model="formValidate.topicName" placeholder="请选择">
          <Option
...
export default {
  ...
  methods: {
    ...
    getFormData() {
      ...
      let postData = {
        name: '', topicName: '', user: '', cluster: '', state: ''
      }
